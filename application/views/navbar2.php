            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <div class="row white">
                                <div class="hidden-xs col-sm-1 col-md-1 margin-top">
                                </div>
                                <div class="col-xs-12 col-sm-2 col-md-2 margin-top">
                                    <li><b>Tipo</b></li>
                                ...
                                <div class="col-xs-12 col-sm-1 col-md-1 margin-top">
                                    <li><b>Marcas</b></li>
                                ...
                                <div class="hidden-xs col-md-5 text-right" style="padding: 0px;">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <div class="row white">
                                ...
                                <div class="hidden-xs col-md-6 text-right" style="padding: 0px;">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <div class="row white">
                                <div class="hidden-xs col-md-12 text-right" style="padding: 0px;">
